...
export default function HeroSection() {
 ...
 return (
  ...
  >
   ...
   {/* Right side: 2x2 grid icons with wave + bounce ONLY on GitHub */}
   <motion.div
    ...
    >
     {iconBoxes.map(({ icon, label }, i) => {
      ...
      return (
       ...
       >
        {/* Wave ripple only behind GitHub */}
        {isGithubBox && (
         <motion.div
        ...
        {/* Bounce animation only on GitHub icon box */}
        {isGithubBox ? (
         <motion.div
          variants={bounceVariants}
          animate="animate"
          whileHover={{ scale: 1.1 }}      // <-- motion hover scale here
         ...
         <motion.div
          whileHover={{ scale: 1.1 }}     // <-- motion hover scale here for others too
          style={{ width: "100%", height: "100%", cursor: "pointer" }}
         >
          <Box
           sx={{
