...
import {
    Send, Github, Linkedin, Twitter, Mail, MapPin,
    ArrowUpRight, CheckCircle, AlertCircle, Loader2,
    Clock, MessageSquare,
} from "lucide-react";
...
//  3. Create a Template (use variables below)   → copy TEMPLATE_ID
    ...
    return (
        ...
        >
            <div style={{ maxWidth: 1050, margin: "0 auto" }}>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p style={{ margin: 0, color: "var(--text-secondary)", fontFamily: "'MyCustomFont', sans-serif", fontSize: 14, lineHeight: 1.7 }}>
                                            Thanks for reaching out, <strong style={{ color: "var(--text-primary)" }}>{form.name || "friend"}</strong>!<br />
                ...
                <div
                    data-gsap="fade-up"
                    style={{ marginTop: 80, paddingTop: 30, borderTop: "1px solid var(--bg-card-border)", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}
                >
                    <p style={{ margin: 0, fontSize: 13, color: "var(--text-muted)", fontFamily: "'MyCustomFont', sans-serif" }}>
                        © 2025 Ayush Kumar. Built with Next.js &amp; ❤️
                    </p>
                    <p style={{ margin: 0, fontSize: 13, color: "var(--text-muted)", fontFamily: "'MyCustomFont', sans-serif" }}>
